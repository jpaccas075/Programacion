...
public class CalculadoraBasicaApp {
	...
	public static void main(String[] args) {
		...
		case 'S':
			System.out.println("El resultado de sumar " + primerOperando + " y " + segundoOperando + " es: " + (primerOperando + segundoOperando));
			break;
		case 'R':
			System.out.println("El resultado de restar " + primerOperando + " y " + segundoOperando + " es: " + (primerOperando - segundoOperando));
			break;
		case 'P':
			System.out.println("El resultado de multiplicar " + primerOperando + " por " + segundoOperando + " es: " + (primerOperando * segundoOperando));
			break;
		case 'D':
