...
class TestAutomovil {
  ...
  void testAutomovilaFechaNull() {
    ...
    assertThrows(IllegalArgumentException.class, () -> new Automovil("1111 AAA", null, Automovil.COLOR_BLANCO, 4));
  }
  ...
  void testAutomovilColorNull() {
    ...
    // Resultado esperado: El objeto NO se crea y lanza la excepción IllegalArgumentException
    assertThrows(IllegalArgumentException.class, () -> new Automovil("1111 AAA", new Fecha(1,10,2023), null, 4));
  }
